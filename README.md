...
Here are the main features of Calc(ify):

- Interpretes user-inputted equation into a form readable by computer (what we're dubbing code)
- Uses AI to automate mental calculation of math expressions
- Provides user with AI supplemented customer support
- Innovative Engaging progression system
